...
namespace DebugxLog
{
    public class DebugxConsole : EditorWindow
    {
        ...
        private void OnGUI()
        {
            ...
            EditorGUILayout.LabelField("Playing Settings", GUIStyle.Get.TitleStyle_2);
            if (!Application.isPlaying) EditorGUILayout.HelpBox("在游戏运行时才能设置这部分内容", MessageType.Info);
            EditorGUI.BeginDisabledGroup(!Application.isPlaying);
            EditorGUILayout.LabelField("Toggle", GUIStyle.Get.TitleStyle_3);
            ...
            EditorGUILayout.Space();
            EditorGUILayout.LabelField("Members", GUIStyle.Get.TitleStyle_3);
