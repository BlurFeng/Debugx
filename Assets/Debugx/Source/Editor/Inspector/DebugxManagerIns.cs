...
namespace DebugxLog
{
    ...
    public class DebugxManagerIns : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            //SerializedProperty debugxConfig = serializedObject.FindProperty("debugxConfig");
            ...
            //EditorGUILayout.PropertyField(debugxConfig, new GUIContent("DebugxConfig", "调试成员配置"));
            ...
            //    if(DebugxManager.Instance.Settings != null)
            //    {
            //        EditorUtility.SetDirty(DebugxManager.Instance.Settings);
            //        AssetDatabase.SaveAssetIfDirty(DebugxManager.Instance.Settings);
            //    }
            //}
        }
    }
